...
namespace TowerDefense.Models.WeaponUpgrades
{
    public class DoubleBullet(IWeapon weapon) : WeaponDecorator(weapon)
    {
        ...
        private Bullet CalculateSecondBullet(Bullet firstBullet, Enemy enemy)
        {
            ...
            if (distance == 0)
            {
                return new Bullet(firstBullet.X, firstBullet.Y, firstBullet.EnemyId, firstBullet.Damage, firstBullet.Flyweight);
            }
            ...
            return new Bullet(secondBulletX, secondBulletY, firstBullet.EnemyId, firstBullet.Damage, firstBullet.Flyweight);
        }
